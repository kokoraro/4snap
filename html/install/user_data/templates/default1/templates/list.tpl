		...
		<table cellspacing="0" cellpadding="0" summary=" " id="container">
			<tr valign="top">
				...
				<tr valign="top">
					...
					<td align="center" valign="middle"><!--★画像★--><div id="picture"><a href="<!--{$smarty.const.DETAIL_P_HTML}--><!--{$arrProducts[cnt].product_id}-->"><!--商品写真--><img src="<!--{$smarty.const.IMAGE_SAVE_URL|sfTrimURL}-->/<!--{$arrProducts[cnt].main_list_image}-->" alt="<!--{$arrProducts[cnt].name|escape}-->" /></a></div></td>
					<td align="right">
